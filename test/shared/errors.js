module.exports = {
  ...
  TRANSACTION_VALUE_BELOW_MINT_PRICE:
    "SimpleNft: Transaction value below mint price",
  MAXIMUM_QTY_MINTED: "Mintable: maximum minted",
  CALLER_NOT_OWNER_OR_MINT_NOT_STARTED:
    "SimpleNft: caller is not the owner or mint not started",
